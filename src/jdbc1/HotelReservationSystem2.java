...
public class HotelReservationSystem2 {
    private static final String url = "jdbc:mysql://localhost:3306/hojo";
    ...
    private static void viewReservations(Connection connection) throws SQLException {
        String sql = "SELECT reservatiion_id, guest_name, room_no, contact_no, reservation_date FROM reservations";
        ...
        try (Statement statement = connection.createStatement();
            ...
            while (resultSet.next()) {
                int reservationId = resultSet.getInt("reservatiion_id");
    ...
    private static void deleteReservation(Connection connection, Scanner scanner) {
        try {
            ...
            String sql = "DELETE FROM reservations WHERE reservatiion_id = " + reservationId;
